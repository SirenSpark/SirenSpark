"""
GeoJSONReader
Effectue une lecture sur un fichier GeoJSON en utilisant gdal
"""
import logging
...
class GeoJSONReader:
    ...
    def run(self):
        ...
        geojson_ds = ogr.Open(self.filepath)

        if not geojson_ds:
            logging.error(f"Failed to open GeoJSON file: {self.filepath}")
        ...
        # Get the attribute types from the GeoJSON file
        column_types = {}
        ...
        if geometry:
            # Get the spatial reference system of the GeoJSON file
